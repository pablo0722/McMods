...
package net.mcreator.pruebamod.client.renderer;
...
import net.mcreator.pruebamod.entity.model.RedPandaModel;
...
public class RedPandaRenderer extends GeoEntityRenderer<RedPandaEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RedPandaEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
