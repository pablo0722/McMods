...
public class FlyingDragonPathNavigation extends PathNavigation {
   public FlyingDragonPathNavigation(Mob p_26424_, Level p_26425_) {
   ...
   public void tick() {
      ...
      System.out.println(System.identityHashCode(this) + " getNextEntityPos");
